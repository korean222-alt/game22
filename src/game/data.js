...
/* ---- 랭크 사다리와 스태미나 ----
   `rank` 는 이 플랫폼이 열리는 회사 랭크다. 처음에는 0·2·5·9·14·20 이라
   콘솔을 한 번 만져 보려면 몇 년을 기다려야 했고, 그 사이의 화면에는
   "랭크 14 필요" 라고 적힌 회색 줄만 여섯 개가 서 있었다. 그래서 한 칸에
   하나씩(1..6) 으로 줄였는데, 이번에는 반대쪽이 걸렸다 — 여섯 칸이면
   사다리가 초반에 다 끝나고, 그 뒤의 랭크는 정원과 상한만 오르는 숫자가
   된다. 새 플랫폼은 이 게임에서 가장 큰 선물인데 그것을 다 써 버리는 셈이다.

   그래서 **두 칸에 하나씩** (1·3·5·7·9·11) 으로 늘린다. 한 랭크는 여전히
   무언가를 열지만(사이 칸은 층·수익 모델·도우미 자리·상점이 맡는다),
   플랫폼은 두 칸을 모아야 하나가 온다. 사다리가 회사 수명 전체에 걸쳐
   펴지고, 마지막 자체 플랫폼은 실제로 오래 키운 회사의 물건이 된다.
...
export const PLATFORMS = [
  ...
  { id: 'smart', ko: '스마트폰', rank: 3, tier: 1, stamina: 5, fans: 1.00, hp: 1.60, cost: 42000, share: 1.00, market: 21_000_000, note: '표준. 넓이도 구매력도 무난하다.' },
  { id: 'sns', ko: 'SNS 플랫폼', rank: 5, tier: 2, stamina: 7, fans: 1.35, hp: 2.60, cost: 95000, share: 1.25, market: 34_000_000, note: '입소문이 가장 빠르게 퍼진다.' },
  { id: 'tablet', ko: '태블릿', rank: 7, tier: 3, stamina: 9, fans: 1.20, hp: 3.20, cost: 160000, share: 1.10, market: 27_000_000, note: '오래 붙잡고 하는 게임에 맞는다.' },
  { id: 'console', ko: '콘솔 크로스', rank: 9, tier: 4, stamina: 11, fans: 1.60, hp: 5.00, cost: 340000, share: 1.45, market: 52_000_000, note: '한 명이 쓰는 돈이 크다. 개발비도 크다.' },
  { id: 'own', ko: '자체 플랫폼', rank: 11, tier: 5, stamina: 13, fans: 2.10, hp: 7.50, cost: 720000, share: 2.00, market: 96_000_000, note: '수수료가 없다. 회사가 곧 시장이다.' },
];
...
export function rankInfo(rank) {
  ...
  return {
    ...
    /* 스태미나는 이제 **개발 착수 한 자리**에서만 나간다. 기획서·교육·
       ...
       시작할 수 있는가** 가 된다. 스태미나 사다리(3·5·7·9·11·13)는 열리는
       랭크(1·3·5·7·9·11)에서 언제나 여유 있게 서야 한다 — 콘솔이 열리는
       랭크 9 의 상한이 22 이므로 11 짜리 착수에 ★5(+2)를 얹어도 남는다. */
