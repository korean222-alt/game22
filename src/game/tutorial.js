...
export const TUTORIAL = [
  ...
  },
  {
    ...
    tab: 'dev',
    title: '개발을 시작하세요',
    body: '기획서를 고르고 플랫폼·수익 모델·팀을 정한 뒤 <b>개발 시작</b>. 개발비와 <b>착수 스태미나</b>가 듭니다 — 스태미나는 여기서만 나갑니다.',
  ...
  },
  {
    ...
    tab: 'dev',
    title: '아이디어를 물리치세요',
    body: '보스가 <b>세 마리</b> 나옵니다. 직원들이 <b>자동으로</b> 공격하니 지켜보기만 하면 됩니다. 지치면 밥을 먹이거나 다음 주로 넘겨 쉬게 하세요.',
