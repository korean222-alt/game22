...
export const TUTORIAL = [
  ...
  },
  {
    ...
    tab: 'dev',
    title: '홍보를 걸고 출시하세요',
    body: '버그는 마지막 공정의 <b>버그 보스</b>가 가져갑니다 — 끝까지 잡으면 0개가 되고, '
      + '이 한 마리는 때리지 않는 대신 <b>제한시간</b>이 있습니다. 앞에서 반격을 많이 맞았을수록 '
      + '그만큼 커져서 기다립니다. '
  ...
  },
  {
    ...
    /* 이 줄 하나 때문에 안내가 통째로 없어졌던 적이 있다. 조건이 "상점에서
       돈을 썼는가" 뿐이라, 가구만 사고 상점은 안 들른 사람에게는 **끝낼
       방법이 화면에 없는** 줄이 되어 영영 지워지지 않았다. 이제 상점 탭을
       한 번 열어 보기만 해도 끝난다 — 안내의 일은 데려다 놓는 것이지
       무언가를 사게 만드는 것이 아니다. */
    done: (g) => (g.company.spentOnShop || 0) > 0 || !!(g.company.seenTabs || {}).shop,
  },
  {
    id: 'manage',
    tab: 'company',
    title: '운영과 연구를 보세요',
    body: '출시작은 실시간 판매로 12주치 매출을 정산한 뒤 서비스를 종료합니다. <b>시간은 일하면 흐릅니다</b> — 게임을 완성하고, '
