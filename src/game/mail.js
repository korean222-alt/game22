...
/* ---------- 창업 축하 ----------
   ...
   창업 지원금을 10만으로 내리면서 이쪽을 5만으로 올렸다. 시작 자본의 총합은
   비슷하지만 **절반이 편지함 안에** 있다: 첫 화면에서 쓸 수 있는 돈이 줄어
   책상 한 개를 어디에 놓을지가 진짜 선택이 되고, 편지함이 게임 첫 분에
   한 번은 열리는 곳이 된다. */
export const WELCOME_GRANT = 50000;
